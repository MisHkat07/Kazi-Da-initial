    ...
    !(function () {
      ...
      function v() {
        if (document.body) {
          var t,
            ...
            c = o.scrollHeight;
          if (
            ((i = document.compatMode.indexOf("CSS") >= 0 ? l : o),
            (e = o),
            ...
            if (
              ...
              setTimeout(function () {
                s ||
                  l.scrollHeight == document.height ||
                  ((s = !0),
                  setTimeout(function () {
                    (l.style.height = document.height + "px"), (s = !1);
                  }, 500));
              }, 10),
              i.offsetHeight <= u)
            ) {
              var d = document.createElement("div");
              (d.style.clear = "both"), o.appendChild(d);
            }
          }
          n.fixedBackground ||
      ...
      function S(e, t, r, a) {
        ...
        if (
          ...
          (i = (i = t) > 0 ? 1 : -1),
          (l = (l = r) > 0 ? 1 : -1),
          (o.x !== i || o.y !== l) && ((o.x = i), (o.y = l), (b = []), (g = 0)),
          1 != n.accelerationMax)
        ) {
          var u = +new Date() - g;
          if (u < n.accelerationDelta) {
            var c = (1 + 30 / u) / 2;
            c > 1 && ((c = Math.min(c, n.accelerationMax)), (t *= c), (r *= c));
          }
          g = +new Date();
        }
        if (
          ...
          _(
            function o(i) {
              ...
              s
                ? window.scrollBy(u, c)
                : (u && (e.scrollLeft += u), c && (e.scrollTop += c)),
                t || r || (b = []),
      ...
      function k(t) {
        ...
        var a = 0,
          ...
          l = T(e),
          v = l.clientHeight;
        switch ((l == document.body && (v = window.innerHeight), t.keyCode)) {
          case c:
            i = -n.arrowScroll;
            break;
          case d:
      ...
      function H(e, t) {
        for (var n = e.length; n--; ) x[D(e[n])] = t;
        return t;
      }
      function T(e) {
        var t = [],
        ...
        do {
          ...
          if ((t.push(e), n === e.scrollHeight)) {
            if (!r || i.clientHeight + 10 < n) return H(t, document.body);
          } else if (e.clientHeight + 10 < e.scrollHeight) {
            var a = getComputedStyle(e, "").getPropertyValue("overflow-y");
            if ("scroll" === a || "auto" === a) return H(t, e);
          }
      ...
      function P(e) {
        return e >= 1
          ...
          : e <= 0
          ? 0
          : (1 == n.pulseNormalize && (n.pulseNormalize /= z(1)), z(e));
      }
            ...
            var r = t.target,
              ...
              i =
                document.documentElement.className
                  ...
                  .filter(function (e) {
                    return (
                      "et-fb-preview--tablet" === e ||
                      "et-fb-preview--phone" === e ||
                      "et-fb-preview--zoom" === e ||
                      "et-fb-preview--wireframe" === e
                    );
                  }).length > 0;
            if (
              !o ||
