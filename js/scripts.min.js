                        ...
                        n(this)
                          ...
                          .each(function () {
                            ...
                            if (a) {
                              ...
                              o += ""
                                .concat(c, "{ bottom: ")
                                .concat(l.toString(), "px ; }");
                            } else (l = Math.floor(r.offset().top + r.outerHeight() - e) - 1), (o += "".concat(c, "{ top: ").concat(l.toString(), "px ; }"));
                          });
                    ...
                    setTimeout(function () {
                      n("#et_fix_html_margin").remove(),
                        n("<style />", {
                          ...
                          text: "html.js.et-fb-top-html { margin-top: 0px ; }",
                        }).appendTo("head");
                    }, 0);
                }
                function S(t) {
            ...
            if (
              ...
              t("#et_fix_page_container_position").length ||
                t("<style />", {
                  ...
                  text: "#page-container{ padding-top: 0 ;}",
                }).appendTo("head");
